...
const STORAGE_PATH = path.join(
  __dirname,
  "../../../auth/storage/shine_auth.json",
);

async function shineLogin() {
  console.log("\n🔐 Shine.com Login\n");
  console.log("A browser window will open. Please:");
  console.log("  1. Log in to your shine account manually");
  ...
  console.log("🌐 Opening shine.com login page...");
  await page.goto("https://www.shine.com/myshine/login/", {
